  ...
  const loadFinalizedSpecs = async (account: string) => {
    try {
      ...
      const convertedSpecs: SpecData[] = finalizedSpecs.map(spec => ({
        ...
        targetContract: spec.targetContract || "0xA819D2d3A2820995701cF46F8a314C7040d86BEe",
    ...
    try {
      ...
      try {
        ...
        const contract = new ethers.Contract(
          "0xA819D2d3A2820995701cF46F8a314C7040d86BEe",
          [
        ...
        const specIds = await contract.getSpecsByContract("0xA819D2d3A2820995701cF46F8a314C7040d86BEe", 11155111);
